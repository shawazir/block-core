...
public class BigMath {
	...
	// numbers greater than 10^MAX_DIGITS_10 or e^MAX_DIGITS_E are considered unsafe
	// ('too big') for floating point operations
	 ...
	 *         {@code Nan} if argument is negative, {@code NEGATIVE_INFINITY} if
	 *         zero.
	 */
	 ...
	 * <p>
	 * Works for really big (or really small) arguments, even outside the double
	 * range.
	 * 
	 * @param val
	 *            Argument
	...
	/**
	 * Computes the exponential function, returning a {@link BigDecimal} (precision
	 * ~ 16).
	 * <p>
	 * Works for very big and very small exponents, even when the result falls
	 * outside the double range.
	 *
	 * @param exponent
	 *            Any finite value (infinite or {@code Nan} throws
	 *            {@code IllegalArgumentException})
	 * @return The value of {@code e} (base of the natural logarithms) raised to the
	 *         given exponent, as in {@link java.lang.Math#exp(double)}
	 */
	 ...
	 * <p>
	 * Works even for outputs that fall outside the {@code double} range. <br>
	 * The only limitation is that {@code b * log(a)} cannot exceed the
	 * {@code double} range.
	 * 
	 * @param a
	 *            Base. Should be non-negative
	 * @param b
	 *            Exponent. Should be finite (and non-negative if base is zero)
	 * @return Returns the value of the first argument raised to the power of the
	 *         second argument.
	 */
